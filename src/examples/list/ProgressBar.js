...
import { List, ProgressBar   } from "@lightningjs/ui";
import { Item, ImageCell } from "../itemComponents";
import { Lightning, Colors, Utils } from "@lightningjs/sdk";

export default class Progress extends Page {
  static _template() {
    return {
      ...super._template(),
      Content: {
        ProgressBar: { type: ProgressBar  , x: 90, y: 195, w: 400, h: 10},
      },
    };
  }
  _init() {
  ...
  _focus() {
    ...
    this.tag("ProgressBar").focusAnimation = this.animation({duration: 0.5, actions: [
